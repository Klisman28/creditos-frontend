          ...
          <TableRow v-for="item in courses" :key="item.id">
            ...
            <TableCell>
              <div
                ...
                :class="{
                  'text-primary [&_span]:bg-primary': item.category === 'Graphic Template',
                  'text-warning [&_span]:bg-warning': item.category === 'Development',
            ...
            <TableCell>{{ currency(item.earned) }}</TableCell>
